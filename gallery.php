...
<head>
        ...
        <title>NPIT Solutions|Gallery</title>
...
src="https://www.facebook.com/tr?id=1257673967966242&amp;ev=PageView&amp;noscript=1"
/></noscript>
            ...
            <div class="container">
                <div class="banner_inner_content">
                    ...
                    <ul>
                        ...
                        <li><a href="gallery-two-column.php">gallery </a></li>
                    </ul>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="grid_gallery_inner">
                    ...
                    <div class="row grid_gallery_item_inner imageGallery1">
                        ...
                        <div class="col-md-4 col-xs-6 rooms ">
                            <div class="grid_gallery_item">
                        ...
                        <div class="col-md-4 col-xs-6 env">
                            <div class="grid_gallery_item">
                                <img src="img/new-img/e1.jpg" alt="">
                                <div class="resort_g_hover">
                                    <div class="resort_hover_inner">
                                        <a class="light" href="img/new-img/e1.jpg"><i class="fa fa-expand" aria-hidden="true"></i></a> 
                                        <h5>Our Gallery</h5>
                                    </div>
                                </div>
                            </div>
                     ...
                     <!--    <div class="col-md-4 col-xs-6 env">
                            <div class="grid_gallery_item">
                                <img src="img/new-img/e3.jpg" alt="">
                                <div class="resort_g_hover">
                                    <div class="resort_hover_inner">
                                        <a class="light" href="img/new-img/e3.jpg"><i class="fa fa-expand" aria-hidden="true"></i></a> 
                                        <h5>Our Gallery</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-xs-6 env">
                            <div class="grid_gallery_item">
                                <img src="img/new-img/e4.jpg" alt="">
                                <div class="resort_g_hover">
                                    <div class="resort_hover_inner">
                                        <a class="light" href="img/new-img/e4.jpg"><i class="fa fa-expand" aria-hidden="true"></i></a> 
                                        <h5>Our Gallery</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-xs-6 env">
                            <div class="grid_gallery_item">
                                <img src="img/new-img/e5.jpg" alt="">
                                <div class="resort_g_hover">
                                    <div class="resort_hover_inner">
                                        <a class="light" href="img/new-img/e5.jpg"><i class="fa fa-expand" aria-hidden="true"></i></a> 
                                        <h5>Our Gallery</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-xs-6 env">
                            <div class="grid_gallery_item">
                                <img src="img/new-img/e6.jpg" alt="">
                                <div class="resort_g_hover">
                                    <div class="resort_hover_inner">
                                        <a class="light" href="img/new-img/e6.jpg"><i class="fa fa-expand" aria-hidden="true"></i></a> 
                                        <h5>Our Gallery</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-xs-6 env">
                            <div class="grid_gallery_item">
                                <img src="img/new-img/e7.jpg" alt="">
                                <div class="resort_g_hover">
                                    <div class="resort_hover_inner">
                                        <a class="light" href="img/new-img/e7.jpg"><i class="fa fa-expand" aria-hidden="true"></i></a> 
                                        <h5>Our Gallery</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-xs-6 env">
                            <div class="grid_gallery_item">
                                <img src="img/new-img/e8.jpg" alt="">
                                <div class="resort_g_hover">
                                    <div class="resort_hover_inner">
                                        <a class="light" href="img/new-img/e8.jpg"><i class="fa fa-expand" aria-hidden="true"></i></a> 
                                        <h5>Our Gallery</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-xs-6 env">
                            <div class="grid_gallery_item">
                                <img src="img/new-img/e9.jpg" alt="">
                                <div class="resort_g_hover">
                                    <div class="resort_hover_inner">
                                        <a class="light" href="img/new-img/e9.jpg"><i class="fa fa-expand" aria-hidden="true"></i></a> 
                                        <h5>Our Gallery</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-xs-6 env">
                            <div class="grid_gallery_item">
                                <img src="img/new-img/e10.jpg" alt="">
                                <div class="resort_g_hover">
                                    <div class="resort_hover_inner">
                                        <a class="light" href="img/new-img/e10.jpg"><i class="fa fa-expand" aria-hidden="true"></i></a> 
                                        <h5>Our Gallery</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-xs-6 env">
                            <div class="grid_gallery_item">
                                <img src="img/new-img/room/home1.jpg" alt="">
                                <div class="resort_g_hover">
                                    <div class="resort_hover_inner">
                                        <a class="light" href="img/new-img/room/home1.jpg"><i class="fa fa-expand" aria-hidden="true"></i></a> 
                                        <h5>Our Gallery</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-xs-6 env">
                            <div class="grid_gallery_item">
                                <img src="img/new-img/room/home2.jpg" alt="">
                                <div class="resort_g_hover">
                                    <div class="resort_hover_inner">
                                        <a class="light" href="img/new-img/room/home2.jpg"><i class="fa fa-expand" aria-hidden="true"></i></a> 
                                        <h5>Our Gallery</h5>
                                    </div>
                                </div>
                            </div>
       ...
       ?>
        ...
        <section class="android-call-button hidden-md hidden-lg visible-xs visible-sm   ">
             <div class="row">
              ...
              <div class="col-xs-4 "><a href="https://api.whatsapp.com/send?phone=919325756647" class=""><i class="fa fa-whatsapp" aria-hidden="true"></i><strong>
              Whatsapp</strong></a></div>
            <div class="col-xs-4 "><a href="mailto:info@shivnerifortvalley.com" class=""><i class="fa fa-envelope" aria-hidden="true"></i>
             <strong>Enquiry</strong></a></div></div>
        </section>    
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <ul style="text-align:right">
                                    <li style="display:inline;padding:10px"><a href="https://api.whatsapp.com/send?phone=919325756647"><i class="fa fa-whatsapp" style="font-size:30px;color:#4d1b00;margin-left:5px"></i></a></li>
                                    <li style="display:inline"><a href="tel:9325756647" class=""><i class="fa fa-phone" style="font-size:30px;color:#4d1b00"></i></a></li>
                                </ul>
                            </div>
            ...
            <div class="modal-body">
                 <form action="https://www.shivnerifortvalley.com/payment.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                     <div class="col-md-12">
                            <label for="exampleInputEmail1">Phone Number</label>
                            <input type="text" class="form-control" name="phone" id="phone" aria-describedby="emailHelp" maxlength="10" required>
                        </div>    
                    </div>
